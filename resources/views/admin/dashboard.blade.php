						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding updates collapse in" id="collapseG3">
								...
								<div class="new-update clearfix">
									...
									<span class="update-date">
										<span class="update-day">07</span>Jan
									</span>
								</div>
								...
								<div class="new-update clearfix">
									...
									<span class="update-done">
										<a title="" href="#">
											<strong>Envato approved Maruti Admin template</strong>
										</a>
										<span>i am very happy to approved by TF</span>
									</span>
									<span class="update-date">
										<span class="update-day">05</span>jan
									</span>
								</div>
									...
									<div class="panel-content nopadding">
										<ul class="contact-list">
											<li id="user-Alex" class="online">
												<a href="">
													<img alt="" src="{{ asset('images/backend_images/demo/av1.jpg') }}" />
													<span>Alex</span>
												</a>
											</li>
											...
											<li id="user-Linda">
												<a href="">
													<img alt="" src="{{ asset('images/backend_images/demo/av2.jpg') }}" />
													<span>Linda</span>
												</a>
											</li>
											...
											<li id="user-John" class="online new">
												<a href="">
													<img alt="" src="{{ asset('images/backend_images/demo/av3.jpg') }}" />
													<span>John</span>
												</a>
											...
											<li id="user-Mark" class="online">
												<a href="">
													<img alt="" src="{{ asset('images/backend_images/demo/av4.jpg') }}" />
													<span>Mark</span>
												</a>
											</li>
											...
											<li id="user-Maxi" class="online">
												<a href="">
													<img alt="" src="{{ asset('images/backend_images/demo/av5.jpg') }}" />
													<span>Maxi</span>
												</a>
											</li>
										</ul>
						...
						<div class="accordion" id="collapse-group">
							...
							<div class="accordion-group widget-box">
								...
								<div class="collapse accordion-body" id="collapseGTwo">
									<div class="widget-content">
										And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.
									</div>
								</div>
							</div>
						...
						<div class="widget-box">
							...
							<div class="widget-content tab-content">
								<div id="tab1" class="tab-pane active">
									<p>
										And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment.
									</p>
									<img src="{{ asset('images/backend_images/demo/demo-image1.jpg') }}" alt="demo-image"/>
								</div>

								<div id="tab2" class="tab-pane">
									<img src="{{ asset('images/backend_images/demo/demo-image2.jpg') }}" alt="demo-image"/>
									<p>
										And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment.
									</p>
								</div>
